...
RSpec.describe IsoDoc do
  it "processes IsoXML bibliographies" do
      ...
      #{HTML_HDR}
             ...
             <div>
               ...
               <p id='ref9' class='NormRef'>
                 ...
                 <span>International Organization for Standardization</span>
                  and
                 <span>International Electrotechnical Commission</span>
                  (
                 <a href='https://www.iso.org/standard/37010.html'>https://www.iso.org/standard/37010.html</a>
                 )
               </p>
               <p id='ISO712' class='NormRef'>
                 [10]&#160; ISO 712: Cereals and cereal products,
                 <span>International Organization for Standardization</span>
               </p>
               ...
               <p id='ISO20483' class='NormRef'>
                 [12]&#160; ISO 20483:2013-2014: Cereals and pulses,
                 <span>International Organization for Standardization</span>
               </p>
    ...
    OUTPUT
    expect(xmlpp(IsoDoc::IHO::PresentationXMLConvert.new({}).convert("test", input, true).sub(
                   %r{<localized-strings>.*</localized-strings>}m, ""
                 ))).to be_equivalent_to xmlpp(presxml)
    expect(xmlpp(IsoDoc::IHO::HtmlConvert.new({}).convert("test", presxml, true).gsub(%r{^.*<body}m, "<body").gsub(
                   %r{</body>.*}m, "</body>"
